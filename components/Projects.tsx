  ...
  return (
    ...
    max-w-full justify-evenly mx-auto items-center z-0'>
        ...
        <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20  scrollbar-track-gray-400/20 scrollbar-thumb-blue-900 scrollbar-thin'>
            ...
            <Project image="https://i.ibb.co/sv7DkPJK/Screen-Shot-2025-03-06-at-10-30-23-AM.png" link='https://dashboard-sooty-six.vercel.app'  title='Dashboard' description='A dashboard example project with a dashboard that displays statistics, various different metrics,customers  and much more information'/>

            <Project image="https://i.ibb.co/tJJGx8m/pexels-junior-teixeira-1064069-2047905.jpg"  link="https://muhira-market.vercel.app/" title='Tour site Clone' description='Custom E-commerce site for a local business'/>
